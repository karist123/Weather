...
class naverWeather():
    ...
    def __init__(self, area="서울") -> object:
        self.area = area
        self.addr = None
        self.result = None
    ...
    def search(self):
        ...
        table = soup.findAll(class_="day_data") # week weather list
        t_ary = list()
        for i in range(table.__len__()):
            t_ary.append(list(table[i].stripped_strings))

        self.result = (
                "[" + self.area + " 날씨 검색 결과]\n"
                + "- 오늘(" + t_ary[0][1] + ")\n"
                + "\t오전 - " + t_ary[0][11] + "℃(" + t_ary[0][5] + ", 강수확률 " + t_ary[0][4] + ")\n"
                + "\t오후 - " + t_ary[0][14] + "℃(" + t_ary[0][9] + ", 강수확률 " + t_ary[0][8] + ")\n"
                + "- 내일(" + t_ary[1][1] + ")\n"
                + "\t오전 - " + t_ary[1][11] + "℃(" + t_ary[1][5] + ", 강수확률 " + t_ary[1][4] + ")\n"
                + "\t오후 - " + t_ary[1][14] + "℃(" + t_ary[1][9] + ", 강수확률 " + t_ary[1][8] + ")\n"
        )
